...
def main():
    files = [
        'prim-matrix-results.csv',
        'prim-list-results.csv',
        'kruskal-matrix-results.csv',
        'kruskal-list-results.csv',
        'dijkstra-matrix-results.csv',
        'dijkstra-list-results.csv',
        'bellman-ford-matrix-results.csv',
        'bellman-ford-list-results.csv'
    ]
    ...
    data_mst_matrix = [data for data in all_data.items() if
                       'matrix' in data[0] and ('prim' in data[0] or 'kruskal' in data[0])]
    mst_matrix(data_mst_matrix)

    data_mst_list = [data for data in all_data.items() if
                     'list' in data[0] and ('prim' in data[0] or 'kruskal' in data[0])]
    ...
    data_tsp_matrix = [data for data in all_data.items() if
                       'matrix' in data[0] and ('dijkstra' in data[0] or 'bellman-ford' in data[0])]
    tsp_matrix(data_tsp_matrix)

    data_tsp_list = [data for data in all_data.items() if
                     'list' in data[0] and ('dijkstra' in data[0] or 'bellman-ford' in data[0])]
